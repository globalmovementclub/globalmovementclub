...
GrandMasterCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as GrandMasterCoin Core, where everyone uses
...
pay attention to for reviewers of GrandMasterCoin Core code.

General GrandMasterCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: GrandMasterCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
