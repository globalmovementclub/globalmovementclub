...
GlobalMovementClub Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 3234.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 3230 for connections and services them.
...
However, in open source software such as GlobalMovementClub Core, where everyone uses
...
pay attention to for reviewers of GlobalMovementClub Core code.

General GlobalMovementClub Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: GlobalMovementClub Core uses tinyformat, which is type safe. Leave them out to avoid confusion
