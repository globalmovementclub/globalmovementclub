...
Only requiring some minor changes is grandmastercoin.cpp.
...
Changes to grandmastercoin.cpp
----------------------
grandmastercoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
