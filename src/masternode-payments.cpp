...
*
*   Why is this needed?
*   - In GrandMasterCoin some blocks are superblocks, which output much higher amounts of coins
...
{
    if(fLiteMode) return; // disable all GrandMasterCoin specific functionality
