...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("GlobalMovementClub Core gmc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gmc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded globalmovementclub transaction") + "\n" +
              "  gmc-tx [options] -create [commands]   " + _("Create hex-encoded globalmovementclub transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded globalmovementclub transaction
