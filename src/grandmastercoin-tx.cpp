...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("GrandMasterCoin Core grandmastercoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  grandmastercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded grandmastercoin transaction") + "\n" +
              "  grandmastercoin-tx [options] -create [commands]   " + _("Create hex-encoded grandmastercoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded grandmastercoin transaction
