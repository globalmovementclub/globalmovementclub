    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("GlobalMovementClub Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    {
        progressBar->setStyleSheet("QProgressBar { background-color: #F8F8F8; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #CBA462, stop: 1 #D7BA88); border-radius: 7px; margin: 0px; }");
    }
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GlobalMovementClub address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and globalmovementclub: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About GlobalMovementClub Core"), this);
    aboutAction->setStatusTip(tr("Show information about GlobalMovementClub Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GlobalMovementClub Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GlobalMovementClub addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GlobalMovementClub addresses"));
    ...
    openAction->setStatusTip(tr("Open a globalmovementclub: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GlobalMovementClub Core help message to get a list with possible GlobalMovementClub Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("GlobalMovementClub Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GlobalMovementClub network", "", count));
    } else {
...
{
    QString strTitle = tr("GlobalMovementClub Core"); // default title
    ...
    // Append title to "GlobalMovementClub Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
