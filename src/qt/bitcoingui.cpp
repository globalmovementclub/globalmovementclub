    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("GrandMasterCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GrandMasterCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and grandmastercoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About GrandMasterCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about GrandMasterCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GrandMasterCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GrandMasterCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GrandMasterCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a grandmastercoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GrandMasterCoin Core help message to get a list with possible GrandMasterCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("GrandMasterCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GrandMasterCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("GrandMasterCoin Core"); // default title
    ...
    // Append title to "GrandMasterCoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
