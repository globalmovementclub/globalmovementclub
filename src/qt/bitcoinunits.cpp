...
QString BitcoinUnits::name(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            ...
            case mGMC: return QString("mGMC");
            case uGMC: return QString::fromUtf8("μGMC");
    ...
    else
    {
        switch(unit)
        {
            case GMC: return QString("tGMC");
            case mGMC: return QString("mtGMC");
            case uGMC: return QString::fromUtf8("μtGMC");
