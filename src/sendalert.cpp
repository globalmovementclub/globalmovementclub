...
2. run gmcd with -printalert or -sendalert like this:
   /path/to/gmcd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://globalmovement.club";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/GlobalMovementClub Core:0.12.0.58/"));
