...
2. run grandmastercoind with -printalert or -sendalert like this:
   /path/to/grandmastercoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://gmastercoin.com";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/GrandMasterCoin Core:0.12.0.58/"));
